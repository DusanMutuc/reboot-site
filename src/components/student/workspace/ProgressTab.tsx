...
import type { CoachProgressCourse, CourseLite, StudentWorkspaceMode } from './types';
    ...
    <Stack spacing={3}>
      ...
      >
        ...
        >
          ...
          <Typography variant="body2" color="text.secondary">
            {coursesError ? coursesError : 'Pick a course to review detailed progress and SmartDocs.'}
          </Typography>
        </Stack>
      </Paper>
