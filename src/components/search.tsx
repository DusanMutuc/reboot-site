  ...
  return (
    ...
    >
      <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.5} alignItems={{ xs: 'stretch', sm: 'center' }}>
        ...
        <Button
          size="small"
          variant="outlined"  // Add this to make border visible
          onClick={() => {
            onClearFilters();
            setAnchorEl(null);
          }}
          sx={{ 
            ...
            color: '#222 !important', 
            borderColor: '#BBB !important',  // Gray border
            '&:hover': {
              borderColor: '#666 !important',  // Darker gray border on hover
              backgroundColor: '#f5f5f5 !important',      // Light gray background on hover
              color: '#222 !important',         // Keep text color consistent
