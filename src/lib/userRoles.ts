...
export function resolveHomePathForRoleCodes(codes: readonly string[]): AppHomePath {
  ...
  // A full membership wins if both assignments are briefly present. The
  // promotion RPC swaps these roles atomically, but this precedence keeps a
  // manually repaired account on the full member home as well.
